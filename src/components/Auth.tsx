...
import { LogIn, LogOut, User as UserIcon, X, Mail, Github, Chrome } from 'lucide-react';
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/60 backdrop-blur-sm animate-in fade-in duration-200">
          <div className="relative bg-white dark:bg-zinc-900 w-full max-w-md p-8 rounded-2xl shadow-2xl border border-zinc-200 dark:border-zinc-800 animate-in zoom-in-95 duration-200">
            <button 
              ...
              className="absolute top-4 right-4 p-2 hover:bg-zinc-100 dark:hover:bg-zinc-800 rounded-full transition-colors text-zinc-400 hover:text-zinc-600 dark:hover:text-zinc-200"
            >
              <X size={20} />
            </button>
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-zinc-500 dark:text-zinc-400 mt-2">Sign in to save and share your canvases</p>
            </div>
            ...
            <div className="relative mb-6">
              ...
              <div className="relative flex justify-center text-xs uppercase"><span className="bg-white dark:bg-zinc-900 px-2 text-zinc-500 font-medium tracking-wider">Or continue with email</span></div>
            </div>
